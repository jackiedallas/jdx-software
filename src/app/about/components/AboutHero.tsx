                            ...
                            <div className="p-8 lg:p-12">
                                ...
                                <div className="max-w-2xl mx-auto">
                                    <div className="flex flex-col items-center text-center">
                                        <div className="w-32 h-32 p-1 bg-gradient-to-r from-blue-500 via-sky-400 to-emerald-500 rounded-full mb-6">
                                            <div className="w-full h-full rounded-full overflow-hidden">
                                                <Image
                                                    src="/professionalheadshot.jpg"
                                                    alt="Jackie Johnson-Dallas"
                                                    width={128}
                                                    height={128}
                                        ...
                                        <div className="flex space-x-4">
                                            ...
                                            <a
                                                href="https://www.facebook.com/jackie.johnsondallas"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="p-2 text-gray-600 hover:text-gray-900 transition-colors duration-200"
                                                aria-label="Facebook"
                                            ...
                                            <a
                                                href="https://www.instagram.com/jackiejohnsondallas/"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="p-2 text-gray-600 hover:text-gray-900 transition-colors duration-200"
                                            ...
                                            <a
                                                href="mailto:jackie.dallas@jdxsoftware.com"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="p-2 text-gray-600 hover:text-gray-900 transition-colors duration-200"
                                                aria-label="Email"
