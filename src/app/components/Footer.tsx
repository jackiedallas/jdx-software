...
export default function Footer() {
    ...
    const footerLinks = {
        product: [
            ...
            { name: 'JDX Newsletter', href: '/software#pulse' },
        ],
        company: [
            { name: 'About', href: '/about' },
            { name: 'Contact', href: '/contact' },
            { name: 'Pulse', href: '/blog' }
        ],
        social: [
            { name: 'GitHub', href: 'https://github.com/jackiedallas', icon: 'github' },
            { name: 'LinkedIn', href: 'https://www.linkedin.com/company/jdx-software', icon: 'linkedin' },
            { name: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61578207667199', icon: 'facebook' },
            { name: 'Instagram', href: 'https://www.instagram.com/jdxsoftware/', icon: 'instagram' }
        ]
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                >
                    <div className="text-gray-400 text-sm">
                        © {currentYear} JDX Software. All rights reserved.
                    </div>
