            ...
            <div className="pt-16"> {/* Account for navbar */}
                ...
                >
                    <div className="w-full max-w-6xl mx-auto space-y-12 sm:space-y-16 lg:space-y-20">
                        ...
                        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                            <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 p-6 sm:p-8 lg:p-12">
                                {/* Content */}
                                <div className="flex flex-col justify-center space-y-4 sm:space-y-6 order-2 lg:order-1">
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-3">
                                        <h3 className="text-2xl sm:text-3xl font-bold text-blue-600 text-center sm:text-left lg:text-left">
                                            AlphaWick
                                        </h3>
                                        <span className="px-3 py-1 bg-blue-100 text-blue-800 text-sm font-medium rounded-full self-center sm:self-start">App Store</span>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm justify-items-center lg:justify-items-start">
                                        <div className="flex items-center space-x-2">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                        ...
                                        <a
                                            ...
                                            className="inline-flex items-center justify-center px-4 sm:px-6 py-3 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transform hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 text-sm sm:text-base"
                                        >
